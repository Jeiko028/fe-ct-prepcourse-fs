...
function tieneEmail(objetoUsuario) {
   ...
   //deberias poner if(objetoUsuario.email) y despues hacer los retornos
...
for (var i= 0; i< objetoUsuario.posts.length; i++){
   ...
   for(var prop in objetoUsuario.posts[i]){
      sumaLikes+=objetoUsuario.posts[i].sumaLikes;
   };
};
return sumaLikes;
*/
